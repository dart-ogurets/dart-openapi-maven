...
a couple of tickets. DO NOT UPGRADE if you are using complex non-named JSON bodies in your requestBodies - *please* move your non-form objects into the `#/components/schemas` section if you are using complex json bodies. This is an _extremely_ bad API smell and as this is an opinionated
generator, I need to remove this support, you should not be using classes called "InlineObject1" and "InlineOBject2".  
